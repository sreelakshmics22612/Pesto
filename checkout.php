    ...
    <form action="" method="POST" onsubmit="return validateForm()">
        ...
        <div class="flex">
            ...
            <div class="inputBox">
                ...
                <input type="number" name="number" min="1000000000" placeholder="Enter your number" required>
            </div>
            <div class="inputBox">
            ...
            <div class="inputBox">
                <span>Pin Code:</span>
                <input type="number" name="pin_code" min="100000" placeholder="e.g. 123456" required>
            </div>
        </div>
